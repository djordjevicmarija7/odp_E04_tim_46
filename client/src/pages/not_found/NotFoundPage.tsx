...
export default function NotFoundStranica() {
  return (
   <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-sky-50 to-white flex items-center justify-center">
      <div className="bg-white/30 backdrop-blur-lg border border-slate-500 shadow-xl rounded-2xl px-10 py-14 text-center max-w-lg w-full">
        ...
        <p className="text-gray-600 mb-6">
          Stranica koju tražite ne postoji ili је premještena.
        </p>
        <Link
          to="/"
